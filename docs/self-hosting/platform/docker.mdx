...
<Steps>
  ...
  <Callout type="info">
    ...
    It should be noted that the new version of ParadeDB requires explicitly enabling the pg_search extension in order to be used by LobeHub. Here we explicitly enable pg_search.
  </Callout>
